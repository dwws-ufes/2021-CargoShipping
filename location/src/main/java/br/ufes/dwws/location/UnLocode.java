 ...
 * 
 * @see <a href="http://www.unece.org/cefact/locode/">
 *      http://www.unece.org/cefact/locode/</a>
 * @see <a href=
 *      "http://www.unece.org/cefact/locode/DocColumnDescription.htm#LOCODE">
 *      http://www.unece.org/cefact/locode/DocColumnDescription.htm#LOCODE</a>
 */
public class UnLocode implements ValueObject<UnLocode> {
    ...
    public UnLocode(String unlocode) {
        this();
        if (!VALID_PATTERN
                .matcher(this.unlocode = Objects.requireNonNull(unlocode, "UN/LOCODE must not be null").toUpperCase())
                .matches()) {
