...
create table cargo.HandlingEvent (id bigint not null, completion_time timestamp not null, unlocode varchar(255) not null, type varchar(255) not null, version timestamp not null, voyage_number varchar(255), tracking_id varchar(255) not null, primary key (id))
...
alter table cargo.HandlingEvent add constraint FKajfr1joyu8ctafvwc3t6t0vgt foreign key (tracking_id) references cargo.Cargo
